...
# URL du site d'aide (GitHub Pages). À adapter si le dépôt/branche change.
URL_AIDE = "https://simonn18.github.io/Optic-Vision-Pro/"


BG    = "#000000"  # Fond app : noir pur
PANEL = "#15151c"  # Panneaux : gris foncé distinct
...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.help = QPushButton("Aide")
        self.help.setFixedHeight(32)
        self.help.setStyleSheet("""
            QPushButton {
                background: #23232f; color: white;
                border: 1px solid #3a3a3a; border-radius: 6px;
                padding: 0 16px; font-size: 12px; font-weight: bold;
            }
            QPushButton:hover { background: #3a3a3a; }
        """)
        self.help.clicked.connect(self._ouvrir_aide)
        ...
        top_layout.addWidget(self.help)
    ...
    def _init_accueil(self):
        ...
        # Bouton aide (ouvre le site dans le navigateur)
        # NB : créé ici mais non placé dans un layout — à positionner où tu veux,
        #      ex. container_layout.addWidget(self.btn_aide, alignment=Qt.AlignRight)
        self.btn_aide = QPushButton(self.T["btn_aide"])
        self.btn_aide.setFixedSize(100, 32)
        self.btn_aide.setStyleSheet("""
            QPushButton {
                font-size: 12px; font-weight: bold;
                border-radius: 16px;
                background-color: #333333;
    ...
    def _ouvrir_aide(self):
        """Ouvre le site d'aide dans le navigateur par défaut."""
        QDesktopServices.openUrl(QUrl(URL_AIDE))
    ...
    def _appliquer_langue(self):
        ...
        if hasattr(self, "btn_aide"):
            self.btn_aide.setText(T["btn_aide"])
    ...
    def _create_actionbar(self):
        ...
        self.btn_precedent.setFixedSize(110, 32)
        ...
        self.btn_exporter.setFixedSize(110, 32)
        ...
        self.btn_exporter_tous.setFixedSize(220, 32)
