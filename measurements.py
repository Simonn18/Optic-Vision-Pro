...
def main(argv):
    if len(argv) < 4:
        print("Usage: python script.py <arteriesPath> <veinsPath> <odPath> <writeFile>")
        return
    
    arteriesPath, veinsPath, odPath, writeFile = argv[1:5]
    
    measuresDict = {}
    for imageName in tqdm.tqdm(sorted(os.listdir(arteriesPath))):
